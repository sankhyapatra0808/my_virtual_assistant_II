...
def placement(q):
    ...
    if "hello" in q:
        ...
        import youtube_video_runner_typed
        youtube_video_runner_typed.video_reader()

    elif "search youtube" in q:
        import youtube_typed
        youtube_typed.youtube_search_results()
        ...
        import search_google_typed
        search_google_typed.google_search()

    elif "search wikipedia" in q:
        import searching_wikipedia_typed
        searching_wikipedia_typed.search_wiki()

    elif "make an email" in q:
        import email_generator_typed
        email_generator_typed.email_generate()
        ...
        import email_bot_typed
        email_bot_typed.send_email_message()
        ...
        import distance_search_typed
        distance_search_typed.distance_search()
