...
def distance_search():
    ...
    choice = input("BOSS, WHAT DO YOU WANT TO SEARCH FIRST : ").lower()
    speak("Boss enter the second destination you want to search for?")
    choice1 = input("BOSS, WHAT DO YOU WANT TO SEARCH SECOND : ").lower()
    speak("Gotcha boss")
    ...
    browser.find_element(By.XPATH,
                         '//*[@id="QA0Szd"]/div/div/div[1]/div[2]/div/div[1]/div/div/div[2]/div[1]/div[2]/div[2]/button').click()
    time.sleep(1)
    browser.find_element(By.XPATH,
                         '//*[@id="modal-dialog"]/div/div[2]/div/div[3]/div/div/div[1]/div[4]/div[2]/div[1]/button').click()
    time.sleep(1)
